    ...
    <div className='navbar'>
      ...
      <div className='navbar-links-group'>
        <ul className='navbar-menu'>
          ...
          <a href='#aboutus' onClick={()=>setMenu("aboutus")} className={menu==="aboutus"?"active":""}>About Us</a>
          <a href='#faq-section' onClick={()=>setMenu("faqs")} className={menu==="faqs"?"active":""}>FAQs</a>
